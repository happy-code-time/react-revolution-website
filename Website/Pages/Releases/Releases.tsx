...
//@ts-ignore
import { Timeline } from '../../../react-revolution/public/react-revolution';

class Releases extends React.Component< { [key: string]: any }, { [key: string]: any }> {
...
\nImport a single scss (module) file, then import it: @import "react-revolution/scss/<file-name>.scss"`,
    ...
    componentDidMount() {
        ...
        let data: string[] = window.location.href.split('/');
        const dataFromUrl: string = data[data.length - 1];
