...
//@ts-ignore
import { SliderFullscreen, Table, SourceCode, Clipboard } from '../../react-revolution/public/react-revolution';
...
class _SliderFullscreen extends React.Component< { [key: string]: any }, { [key: string]: any }> {
                ...
                <div className="code-example mt-4">
                    <div className="code-example-live">
                        <button
                            ...
                            onClick={() => this.toogleFSS(undefined)}
                        >
                            toggle Fullscreen slider
                        </button>
                        {
