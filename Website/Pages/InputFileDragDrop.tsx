...
//@ts-ignore
import { Table, addGlobalMessage, GlobalMessage, InputFileDragDrop, LoadOnScroll, LoadingBoxTop } from '../../react-revolution/public/react-revolution';
...
class _InputFileDragDrop extends React.Component< { [key: string]: any }, { [key: string]: any }> {
...
export default _InputFileDragDrop;
