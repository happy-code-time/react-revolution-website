...
const SvgSettingsGearIcon = (widthHeight: any = 32, color = 'rgb(69,69,69)') => {
    return (
        <svg 
            version="1.1"
...
export default SvgSettingsGearIcon;
