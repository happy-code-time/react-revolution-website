...
const SvgGeneratorAdd = (widthHeight: any = 32, color = 'rgb(69,69,69)') => {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height={`${widthHeight}`} width={`${widthHeight}`} viewBox="0 0 113.25 122.88">
            <g>
                <path
                    fill={`${color}`}
                    d="M77.59,78.72h27.16c4.67,0,8.5,3.82,8.5,8.5v27.17c0,4.67-3.82,8.49-8.5,8.49H77.59c-4.67,0-8.5-3.82-8.5-8.49
...
export default SvgGeneratorAdd;
